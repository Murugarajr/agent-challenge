...
class CharacterizationTestGenerator:
    ...
    def _analyze_function(self, func_node: ast.FunctionDef, full_code: str) -> Dict:
        ...
        for arg in func_node.args.args:
            ...
            # First check for type annotation, then infer from usage
    ...
    def _annotation_to_type(self, annotation: str) -> str:
        """Convert type annotation string to a type category for test generation."""
        ...
        if annotation.startswith('Optional[') or annotation.startswith('Optional '):
            return 'Optional'
        ...
        # Check for Iterable/Sequence types
        if 'Iterable' in annotation or 'Sequence' in annotation:
            return 'iterable'
...
class CharacterizationTestOrchestrator:
    ...
    Note: This class was renamed from 'TestGenerator' to avoid pytest
    collection warnings (pytest collects classes starting with 'Test').
    """
...
TestGenerator = CharacterizationTestOrchestrator
